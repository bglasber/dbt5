...
bool CDMSUTtest::DataMaintenance(PDataMaintenanceTxnInput pTxnInput)
{
	...
	CDataMaintenanceDB m_DataMaintenanceDB(NULL, m_pDBConnection);
	...
	m_DataMaintenance.DoTxn(1, pTxnInput, &m_DataMaintenanceTxnOutput);
...
bool CDMSUTtest::TradeCleanup(PTradeCleanupTxnInput pTxnInput)
{
	...
	CTradeCleanupDB	m_TradeCleanupDB(NULL, m_pDBConnection);
	...
	m_TradeCleanup.DoTxn(1, pTxnInput, &m_TradeCleanupTxnOutput);
