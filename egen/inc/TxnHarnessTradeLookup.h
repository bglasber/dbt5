...
public:
    ...
    void DoTxn( int clientId, PTradeLookupTxnInput pTxnInput, PTradeLookupTxnOutput pTxnOutput )
    {
        ...
        case 1:
            ...
            // Execute Frame 1
            m_db->DoTradeLookupFrame1( clientId, &Frame1Input, &Frame1Output );
        ...
        case 2:
            ...
            // Execute Frame 2
            m_db->DoTradeLookupFrame2( clientId, &Frame2Input, &Frame2Output );
        ...
        case 3:
            ...
            // Execute Frame 3
            m_db->DoTradeLookupFrame3( clientId, &Frame3Input, &Frame3Output );
        ...
        case 4:
            ...
            // Execute Frame 4
            m_db->DoTradeLookupFrame4( clientId, &Frame4Input, &Frame4Output );
            ...
            if (Frame4Output.num_trades_found < 0 || Frame4Output.num_trades_found > 1)
            {
            ...
            else if (Frame4Output.num_found < 1 || Frame4Output.num_found > TradeLookupFrame4MaxRows)
            {
